...
<div class="kc-card mb-3">
    <div class="kc-card-body"
        style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;padding:10px">
        ...
        <form method="GET"
            ...
            <button type="submit" class="btn-kc btn-kc-sm">
            ...
            foreach ($menus as $m): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <div style="font-size:11px;color:#a07850;">
                            ...
                            <div style="display:flex; flex-wrap:wrap; gap:6px;">
                                ...
                                <?php foreach ($m['resep'] as $r): ?>
                                    ...
                                    <span class="kc-badge kc-badge-green"
                                        style="font-weight:500; font-size:11px; border:1px solid #bbf7d0;">

                                        <?= htmlspecialchars($r['nama_bahan']) ?>
                                        :
                                        <strong>
